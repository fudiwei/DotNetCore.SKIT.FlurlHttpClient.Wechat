...
namespace SKIT.FlurlHttpClient.Wechat.TenpayV3.UnitTests
{
    ...
    public partial class TestCase_ResponseDecryptionForGlobalTests
    {
        ...
        public async Task TestDecryptResponseSensitiveProperty_QueryCertificatesResponse()
        {
            ...
            {
                using (var client = new WechatTenpayGlobalClient(new WechatTenpayGlobalClientOptions()
                {
        ...
        {
            static GetSubMerchantResponse GenerateMockResponseModel(Func<string, string> encryptor)
            {
                return SetMockResponseRawStatusAsOk(new GetSubMerchantResponse()
                {
                    Contact = new GetSubMerchantResponse.Types.Contact
                    {
            ...
            static void AssertMockResponseModel(GetSubMerchantResponse response)
            {
            ...
            if (!string.IsNullOrEmpty(TestConfigs.WechatMerchantRSACertificatePrivateKey))
            {
                ...
                {
                    var request = new GetSubMerchantRequest();
                    var response = await client.ExecuteGetSubMerchantAsync(request);
                    AssertMockResponseModel(response);
                }
            }
        }
    ...
    partial class TestCase_ResponseDecryptionForGlobalTests
    {
        ...
        private static WechatTenpayGlobalClient CreateMockClientUseRSA(bool autoDecrypt, string? mockResponseContent = null)
        {
