...
-   提供了微信公众平台 & 开放平台 API 所需的 SHA-1 等算法工具类。
...
-   完整微信公众平台 & 开放平台 API 一览：
    ...
    |  √  |           安全风控            |     小程序 & 小游戏      |                                  |
    |  √  |             直播              |     小程序 & 小商店      |                                  |
    |  ×  |      <del>开店接口</del>      |    <del>小商店</del>     |             _开发中_             |
    |  ×  |    <del>服务市场接口</del>    |    <del>小商店</del>     |             _开发中_             |
    |  ×  |      <del>SPU 接口</del>      |    <del>小商店</del>     |             _开发中_             |
    |  ×  |      <del>SKU 接口</del>      |    <del>小商店</del>     |             _开发中_             |
    |  ×  |      <del>订单接口</del>      |    <del>小商店</del>     |             _开发中_             |
    |  ×  |      <del>物流接口</del>      |    <del>小商店</del>     |             _开发中_             |
    |  ×  |    <del>配送方式接口</del>    |    <del>小商店</del>     |             _开发中_             |
    |  ×  |  <del>运费模板管理接口</del>  |    <del>小商店</del>     |             _开发中_             |
    |  ×  |  <del>线下配送管理接口</del>  |    <del>小商店</del>     |             _开发中_             |
    |  ×  |     <del>优惠券接口</del>     |    <del>小商店</del>     |             _开发中_             |
    |  ×  |      <del>店铺接口</del>      |    <del>小商店</del>     |             _开发中_             |
    |  ×  |  <del>商家地址管理接口</del>  |    <del>小商店</del>     |             _开发中_             |
    |  ×  |      <del>交易组件</del>      |    <del>小商店</del>     |             _开发中_             |
    |  √  |         微信登录功能          |         开放平台         |                                  |
    |  √  |        一次性订阅消息         |         开放平台         |                                  |
    |  √  |        小程序硬件框架         |         开放平台         |                                  |
    |  √  |         开放平台接口          |         开放平台         |                                  |
