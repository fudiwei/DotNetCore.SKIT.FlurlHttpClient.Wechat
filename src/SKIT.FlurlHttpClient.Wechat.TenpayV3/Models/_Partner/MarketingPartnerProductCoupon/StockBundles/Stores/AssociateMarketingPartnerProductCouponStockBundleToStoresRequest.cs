...
{
    /// <summary>
    /// <para>表示 [POST] /marketing/partner/product-coupon/product-coupons/{product_coupon_id}/stock-bundles/{stock_bundle_id}/associate-stores 接口的请求。</para>
    /// </summary>
    public class AssociateMarketingPartnerProductCouponStockBundleToStoresRequest : WechatTenpayRequest
    {
