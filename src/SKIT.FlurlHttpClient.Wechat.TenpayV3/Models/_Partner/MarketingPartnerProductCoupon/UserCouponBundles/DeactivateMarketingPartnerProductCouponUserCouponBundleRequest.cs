...
{
    /// <summary>
    /// <para>表示 [POST] /marketing/partner/product-coupon/users/{openid}/coupon-bundles/{user_coupon_bundle_id}/deactivate 接口的请求。</para>
    /// </summary>
    public class DeactivateMarketingPartnerProductCouponUserCouponBundleRequest : WechatTenpayRequest
    {
        /// <summary>
        /// 获取或设置商品券 ID。
        /// </summary>
        ...
        public string UserCouponBundleId { get; set; } = string.Empty;
