...
{
    /// <summary>
    /// <para>表示 [POST] /marketing/partner/product-coupon/users/{openid}/coupon-bundles 接口的请求。</para>
    /// </summary>
    public class SendMarketingPartnerProductCouponUserCouponBundleRequest : WechatTenpayRequest
    {
