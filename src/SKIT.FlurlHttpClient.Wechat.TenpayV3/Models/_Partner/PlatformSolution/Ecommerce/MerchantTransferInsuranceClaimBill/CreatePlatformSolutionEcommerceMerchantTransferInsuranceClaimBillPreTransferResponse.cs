...
{
    /// <summary>
    /// <para>表示 [POST] /platsolution/ecommerce/mch-transfer/insurance-claim-bills/pre-transfer 接口的响应。</para>
    /// </summary>
    public class CreatePlatformSolutionEcommerceMerchantTransferInsuranceClaimBillPreTransferResponse : WechatTenpayResponse
    {
        /// <summary>
        /// 获取或设置二级商户号。
        /// </summary>
