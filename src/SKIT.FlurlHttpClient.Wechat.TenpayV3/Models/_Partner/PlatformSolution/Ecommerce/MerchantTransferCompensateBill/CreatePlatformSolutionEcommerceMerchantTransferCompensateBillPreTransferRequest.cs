namespace SKIT.FlurlHttpClient.Wechat.TenpayV3.Models
{
    ...
    /// </summary>
    public class CreatePlatformSolutionEcommerceMerchantTransferCompensateBillPreTransferRequest : WechatTenpayRequest
    {
        public static class Types
        {
            public class Receiver : CreatePlatformSolutionEcommerceMerchantTransferCompensateBillRequest.Types.Receiver
            {
            }
        }
