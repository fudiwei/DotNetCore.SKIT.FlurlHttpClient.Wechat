...
{
    /// <summary>
    /// <para>表示 [POST] /platsolution/insurance/mch-transfer/batches/apply 接口的响应。</para>
    /// </summary>
    public class ApplyPlatformSolutionInsuranceMerchantTransferBatchResponse : WechatTenpayResponse
    {
        /// <summary>
        /// 获取或设置商户批次单号。
        /// </summary>
