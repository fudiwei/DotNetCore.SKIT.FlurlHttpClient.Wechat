...
{
    /// <summary>
    /// <para>表示 [POST] /platsolution/insurance/mch-transfer/reservation/apply 接口的响应。</para>
    /// </summary>
    public class ApplyPlatformSolutionInsuranceMerchantTransferReservationResponse : WechatTenpayResponse
    {
        /// <summary>
        /// 获取或设置二级商户号。
        /// </summary>
