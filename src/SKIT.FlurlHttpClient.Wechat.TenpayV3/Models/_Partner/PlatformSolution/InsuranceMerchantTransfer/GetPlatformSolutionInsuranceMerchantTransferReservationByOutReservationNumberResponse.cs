...
{
    /// <summary>
    /// <para>表示 [GET] /platsolution/insurance/mch-transfer/reservation/out-reservation-no/{out_reservation_no} 接口的响应。</para>
    /// </summary>
    public class GetPlatformSolutionInsuranceMerchantTransferReservationByOutReservationNumberResponse : WechatTenpayResponse
    {
