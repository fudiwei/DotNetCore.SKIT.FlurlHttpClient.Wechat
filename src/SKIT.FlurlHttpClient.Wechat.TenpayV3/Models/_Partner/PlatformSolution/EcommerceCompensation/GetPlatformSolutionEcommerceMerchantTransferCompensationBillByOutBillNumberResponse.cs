...
{
    /// <summary>
    /// <para>表示 [GET] /platsolution/ecommerce/mch-transfer/compensate-bills/out-bill-no/{out_bill_no} 接口的响应。</para>
    /// </summary>
    public class GetPlatformSolutionEcommerceMerchantTransferCompensationBillByOutBillNumberResponse : WechatTenpayResponse
    {
