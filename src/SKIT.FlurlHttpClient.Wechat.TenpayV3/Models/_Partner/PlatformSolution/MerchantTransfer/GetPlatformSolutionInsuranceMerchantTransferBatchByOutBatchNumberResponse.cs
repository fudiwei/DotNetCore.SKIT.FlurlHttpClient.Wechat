...
{
    /// <summary>
    /// <para>表示 [GET] /platsolution/insurance/mch-transfer/batches/out-batch-no/{out_batch_no} 接口的响应。</para>
    /// </summary>
    public class GetPlatformSolutionInsuranceMerchantTransferBatchByOutBatchNumberResponse : WechatTenpayResponse
    {
