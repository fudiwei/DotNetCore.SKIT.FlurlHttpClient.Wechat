...
namespace SKIT.FlurlHttpClient.Wechat.TenpayV3.ExtendedSDK.Global.Models
{
    ...
    /// </summary>
    public class CreatePartnerTransactionNativeRequest : WechatTenpayGlobalRequest
    {
        public static class Types
        {
            public class Payer : CreatePartnerTransactionAppRequest.Types.Payer
            {
            }

            public class Amount : CreateTransactionNativeRequest.Types.Amount
            {
            }

            public class Detail : CreateTransactionNativeRequest.Types.Detail
            {
            }

            public class Scene : CreateTransactionNativeRequest.Types.Scene
            {
            }
        }
