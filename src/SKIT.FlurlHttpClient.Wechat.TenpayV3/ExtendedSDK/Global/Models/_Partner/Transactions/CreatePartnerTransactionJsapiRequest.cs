...
namespace SKIT.FlurlHttpClient.Wechat.TenpayV3.ExtendedSDK.Global.Models
{
    ...
    /// </summary>
    public class CreatePartnerTransactionJsapiRequest : WechatTenpayGlobalRequest
    {
        public static class Types
        {
            ...
            public class Amount : CreateTransactionJsapiRequest.Types.Amount
            {
            }

            public class Detail : CreateTransactionJsapiRequest.Types.Detail
            {
            }

            public class Scene : CreateTransactionJsapiRequest.Types.Scene
            {
            }
        }
