...
namespace SKIT.FlurlHttpClient.Wechat.TenpayV3.ExtendedSDK.Global.Models
{
    ...
    /// </summary>
    public class CreatePartnerTransactionMWebRequest : WechatTenpayGlobalRequest
    {
        public static class Types
        {
            ...
            public class Amount : CreateTransactionMWebRequest.Types.Amount
            {
            }

            public class Detail : CreateTransactionMWebRequest.Types.Detail
            {
            }

            public class Scene : CreateTransactionMWebRequest.Types.Scene
            {
            }
        }
