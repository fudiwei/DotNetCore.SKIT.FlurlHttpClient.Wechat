namespace SKIT.FlurlHttpClient.Wechat.Api.Events
{
    ...
    /// <para>
    /// REF: <br/>
    /// <![CDATA[ https://developers.weixin.qq.com/miniprogram/dev/platform-capabilities/business-capabilities/ministore/minishopopencomponent2/callback/aftersale/aftersale_refund_success.html ]]>
    /// </para>
    /// </summary>
    public class AftersaleRefundSuccessEvent : WechatApiEvent
    {
