namespace SKIT.FlurlHttpClient.Wechat.Api.Events
{
    ...
    /// <para>
    /// REF: <br/>
    /// <![CDATA[ https://developers.weixin.qq.com/miniprogram/dev/platform-capabilities/business-capabilities/ministore/minishopopencomponent2/callback/order_refund.html ]]>
    /// </para>
    /// </summary>
    public class OpenProductOrderRefundEvent : WechatApiEvent
    {
