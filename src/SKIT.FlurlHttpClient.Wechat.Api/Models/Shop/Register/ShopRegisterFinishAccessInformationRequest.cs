namespace SKIT.FlurlHttpClient.Wechat.Api.Models
{
    ...
    /// </summary>
    public class ShopRegisterFinishAccessInformationRequest : WechatApiRequest, IInferable<ShopRegisterFinishAccessInformationRequest, ShopRegisterFinishAccessInformationResponse>
    {
        /// <summary>
        /// 获取或设置接入任务类型。
        /// </summary>
