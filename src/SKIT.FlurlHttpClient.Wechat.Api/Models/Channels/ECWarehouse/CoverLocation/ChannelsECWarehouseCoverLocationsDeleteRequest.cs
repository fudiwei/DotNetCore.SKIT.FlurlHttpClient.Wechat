...
{
    /// <summary>
    /// <para>表示 [POST] /channels/ec/warehouse/coverlocations/del 接口的请求。</para>
    /// </summary>
    public class ChannelsECWarehouseCoverLocationsDeleteRequest : WechatApiRequest, IInferable<ChannelsECWarehouseCoverLocationsDeleteRequest, ChannelsECWarehouseCoverLocationsDeleteResponse>
    {
        public static class Types
        {
            public class CoverLocation : ChannelsECWarehouseCoverLocationsAddRequest.Types.CoverLocation
            {
            }
        }
