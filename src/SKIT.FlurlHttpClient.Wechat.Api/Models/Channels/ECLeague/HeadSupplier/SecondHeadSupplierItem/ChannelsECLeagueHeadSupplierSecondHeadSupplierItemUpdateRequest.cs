...
{
    /// <summary>
    /// <para>表示 [POST] /channels/ec/league/headsupplier/secondheadsupplieritem/update 接口的请求。</para>
    /// </summary>
    public class ChannelsECLeagueHeadSupplierSecondHeadSupplierItemUpdateRequest : WechatApiRequest, IInferable<ChannelsECLeagueHeadSupplierSecondHeadSupplierItemUpdateRequest, ChannelsECLeagueHeadSupplierSecondHeadSupplierItemUpdateResponse>
    {
        /// <summary>
