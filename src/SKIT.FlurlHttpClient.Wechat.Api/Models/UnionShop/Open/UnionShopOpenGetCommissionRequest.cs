...
{
    /// <summary>
    /// <para>表示 [POST] /union/shop/open/get_commission 接口的请求。</para>
    /// </summary>
    public class UnionShopOpenGetCommissionRequest : WechatApiRequest, IInferable<UnionShopOpenGetCommissionRequest, UnionShopOpenGetCommissionResponse>
    {
