...
namespace SKIT.FlurlHttpClient.Wechat.Api.Models
{
    ...
    /// </summary>
    public class CgibinTagsMembersBatchBlackListRequest : WechatApiRequest, IInferable<CgibinTagsMembersBatchBlackListRequest, CgibinTagsMembersBatchBlackListResponse>
    {
        /// <summary>
