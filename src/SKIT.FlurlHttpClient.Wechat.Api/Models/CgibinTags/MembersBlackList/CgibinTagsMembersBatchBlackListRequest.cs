...
namespace SKIT.FlurlHttpClient.Wechat.Api.Models
{
    ...
    /// </summary>
    public class CgibinTagsMembersBatchBlackListRequest : WechatApiRequest, IMapResponse<CgibinTagsMembersBatchBlackListRequest, CgibinTagsMembersBatchBlackListResponse>
    {
        /// <summary>
