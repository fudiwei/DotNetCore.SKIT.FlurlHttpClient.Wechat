...
namespace SKIT.FlurlHttpClient.Wechat.Api.Models
{
    ...
    /// </summary>
    public class WxaApiMiniShopBusinessSupplyProofRequest : WechatApiRequest, IInferable<WxaApiMiniShopBusinessSupplyProofRequest, WxaApiMiniShopBusinessSupplyProofResponse>
    {
        /// <summary>
        /// 获取或设置投诉单号。
        /// </summary>
