...
{
    /// <summary>
    /// <para>表示 [POST] /datacube/getusersummary 接口的请求。</para>
    /// </summary>
    public class DataCubeGetUserSummaryRequest : WechatApiRequest, IMapResponse<DataCubeGetUserSummaryRequest, DataCubeGetUserSummaryResponse>
    {
        /// <summary>
