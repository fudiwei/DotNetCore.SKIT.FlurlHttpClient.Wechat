...
{
    /// <summary>
    /// <para>表示 [POST] /cgi-bin/guide/addguidebuyertag 接口的请求。</para>
    /// </summary>
    public class CgibinGuideAddGuideBuyerTagRequest : WechatApiRequest, IMapResponse<CgibinGuideAddGuideBuyerTagRequest, CgibinGuideAddGuideBuyerTagResponse>
    {
        /// <summary>
