...
{
    /// <summary>
    /// <para>表示 [POST] /cgi-bin/guide/getguidebuyerrelation 接口的请求。</para>
    /// </summary>
    public class CgibinGuideGetGuideBuyerRelationRequest : WechatApiRequest, IMapResponse<CgibinGuideGetGuideBuyerRelationRequest, CgibinGuideGetGuideBuyerRelationResponse>
    {
        /// <summary>
