...
namespace SKIT.FlurlHttpClient.Wechat.Api.Models
{
    ...
    /// </summary>
    public class CgibinGuideDeleteGuideBuyerRelationRequest : WechatApiRequest, IInferable<CgibinGuideDeleteGuideBuyerRelationRequest, CgibinGuideDeleteGuideBuyerRelationResponse>
    {
        /// <summary>
