namespace SKIT.FlurlHttpClient.Wechat.Api.Models
{
    ...
    /// </summary>
    public class CgibinGuideAddGuide2GuideGroupRequest : WechatApiRequest, IInferable<CgibinGuideAddGuide2GuideGroupRequest, CgibinGuideAddGuide2GuideGroupResponse>
    {
        /// <summary>
        /// 获取或设置顾问分组 ID。
        /// </summary>
