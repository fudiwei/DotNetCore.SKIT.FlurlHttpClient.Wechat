...
namespace SKIT.FlurlHttpClient.Wechat.Api.Models
{
    ...
    /// </summary>
    public class ProductRegisterSubmitMerchantInfoRequest : WechatApiRequest, IInferable<ProductRegisterSubmitMerchantInfoRequest, ProductRegisterSubmitMerchantInfoResponse>
    {
