...
namespace SKIT.FlurlHttpClient.Wechat.Api.Models
{
    ...
    /// </summary>
    public class ProductRegisterSubmitBasicInfoRequest : WechatApiRequest, IInferable<ProductRegisterSubmitBasicInfoRequest, ProductRegisterSubmitBasicInfoResponse>
    {
