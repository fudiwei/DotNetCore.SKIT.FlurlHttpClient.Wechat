...
namespace SKIT.FlurlHttpClient.Wechat.Api.Models
{
    ...
    /// </summary>
    public class ProductOrderUploadRefundCertificateRequest : WechatApiRequest, IInferable<ProductOrderUploadRefundCertificateRequest, ProductOrderUploadRefundCertificateResponse>
    {
        /// <summary>
        /// 获取或设置售后单号。
        /// </summary>
