namespace SKIT.FlurlHttpClient.Wechat.Api.Models
{
    ...
    /// </summary>
    public class CgibinExpressLocalBusinessOrderReAddRequest : CgibinExpressLocalBusinessOrderPreAddRequest, IInferable<CgibinExpressLocalBusinessOrderReAddRequest, CgibinExpressLocalBusinessOrderReAddResponse>
    {
        /// <summary>
        /// 获取或设置预下单接口返回的参数。
        /// </summary>
