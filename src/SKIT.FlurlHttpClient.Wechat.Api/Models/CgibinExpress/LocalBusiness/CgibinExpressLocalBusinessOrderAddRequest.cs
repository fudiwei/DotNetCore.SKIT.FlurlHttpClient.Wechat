namespace SKIT.FlurlHttpClient.Wechat.Api.Models
{
    ...
    /// </summary>
    public class CgibinExpressLocalBusinessOrderAddRequest : CgibinExpressLocalBusinessOrderPreAddRequest, IInferable<CgibinExpressLocalBusinessOrderAddRequest, CgibinExpressLocalBusinessOrderAddResponse>
    {
        /// <summary>
        /// 获取或设置预下单接口返回的参数。
        /// </summary>
