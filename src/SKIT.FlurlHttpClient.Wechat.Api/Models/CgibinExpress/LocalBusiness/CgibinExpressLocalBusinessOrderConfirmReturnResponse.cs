...
{
    /// <summary>
    /// <para>表示 [POST] /cgi-bin/express/local/business/order/confirm_return 接口的响应。</para>
    /// </summary>
    public class CgibinExpressLocalBusinessOrderConfirmReturnResponse : WechatApiResponse
    {
        /// <summary>
        /// 获取或设置运力返回的错误码。
        /// </summary>
