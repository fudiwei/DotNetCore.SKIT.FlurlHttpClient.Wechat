...
{
    /// <summary>
    /// <para>表示 [POST] /cgi-bin/express/local/business/test_update_order 接口的响应。</para>
    /// </summary>
    public class CgibinExpressLocalBusinessTestUpdateOrderResponse : WechatApiResponse
    {
        /// <summary>
        /// 获取或设置运力返回的错误码。
        /// </summary>
