namespace SKIT.FlurlHttpClient.Wechat.Api.Models
{
    ...
    /// </summary>
    public class CgibinMediaVoiceTranslateContentRequest : WechatApiRequest, IInferable<CgibinMediaVoiceTranslateContentRequest, CgibinMediaVoiceTranslateContentResponse>
    {
        /// <summary>
        /// 获取或设置语音文件字节数组。
        /// </summary>
