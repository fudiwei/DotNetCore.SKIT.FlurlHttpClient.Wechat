...
namespace SKIT.FlurlHttpClient.Wechat.Api.Models
{
    ...
    /// </summary>
    public class CgibinMessageDeviceSubscribeSendRequest : WechatApiRequest, IMapResponse<CgibinMessageDeviceSubscribeSendRequest, CgibinMessageDeviceSubscribeSendResponse>
    {
