namespace SKIT.FlurlHttpClient.Wechat.Api.Models
{
    ...
    /// </summary>
    public class CardInvoiceReimburseGetInvoiceInfoRequest : WechatApiRequest, IInferable<CardInvoiceReimburseGetInvoiceInfoRequest, CardInvoiceReimburseGetInvoiceInfoResponse>
    {
        /// <summary>
        /// 获取或设置发票卡券模板编号。
        /// </summary>
