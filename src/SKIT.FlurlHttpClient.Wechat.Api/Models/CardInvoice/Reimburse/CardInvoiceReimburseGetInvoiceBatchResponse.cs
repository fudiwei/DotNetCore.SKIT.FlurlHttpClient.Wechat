...
{
    /// <summary>
    /// <para>表示 [POST] /card/invoice/reimburse/getinvoicebatch 接口的响应。</para>
    /// </summary>
    public class CardInvoiceReimburseGetInvoiceBatchResponse : WechatApiResponse
    {
        public static class Types
        {
            public class InvoiceCard
            {
                public static class Types
                {
                    public class Invoice : CardInvoiceReimburseGetInvoiceInfoResponse.Types.Invoice
                    {
                    }
                }
