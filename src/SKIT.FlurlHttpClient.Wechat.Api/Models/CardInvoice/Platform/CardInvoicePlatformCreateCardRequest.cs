namespace SKIT.FlurlHttpClient.Wechat.Api.Models
{
    ...
    /// </summary>
    public class CardInvoicePlatformCreateCardRequest : WechatApiRequest, IInferable<CardInvoicePlatformCreateCardRequest, CardInvoicePlatformCreateCardResponse>
    {
