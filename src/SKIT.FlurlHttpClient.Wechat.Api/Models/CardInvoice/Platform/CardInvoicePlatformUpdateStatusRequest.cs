namespace SKIT.FlurlHttpClient.Wechat.Api.Models
{
    ...
    /// </summary>
    public class CardInvoicePlatformUpdateStatusRequest : WechatApiRequest, IInferable<CardInvoicePlatformUpdateStatusRequest, CardInvoicePlatformUpdateStatusResponse>
    {
        /// <summary>
        /// 获取或设置发票或非税票据卡券模板编号。
        /// </summary>
