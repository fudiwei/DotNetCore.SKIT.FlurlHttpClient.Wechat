...
{
    /// <summary>
    /// <para>表示 [POST] /cgi-bin/card/invoice/reimburse/updateinvoicestatus 接口的请求。</para>
    /// </summary>
    public class CgibinCardInvoiceReimburseUpdateInvoiceStatusRequest : WechatWorkRequest
    {
        /// <summary>
        /// 获取或设置发票卡券模板编号。
        /// </summary>
