...
{
    /// <summary>
    /// <para>表示 [POST] /deposit/refundquery 接口的请求。</para>
    /// </summary>
    public class GetDepositRefundRequest : WechatTenpaySignableRequest
    {
        /// <summary>
        /// <inheritdoc/>
        /// </summary>
        ...
        /// <summary>
        /// 获取或设置商户退款单号。与字段 <see cref="RefundId"/> 二选一。
        /// </summary>
        ...
        /// <summary>
        /// 获取或设置微信退款单号。与字段 <see cref="OutRefundNumber"/> 二选一。
        /// </summary>
